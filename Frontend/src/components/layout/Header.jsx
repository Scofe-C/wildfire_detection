    ...
    <header className="h-12 bg-surface-1 border-b border-border-subtle flex items-center justify-between px-5 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          <div className="flex items-center gap-1 px-2 py-1 bg-risk-critical/10 border border-risk-critical/30 rounded text-risk-critical glow-critical">
            <AlertTriangle className="w-3 h-3" />
            <span className="text-[9px] font-mono font-semibold">2 CRITICAL</span>
          </div>
          <div className="flex items-center gap-1 px-2 py-1 bg-accent-orange/10 border border-accent-orange/30 rounded text-accent-orange">
            <AlertTriangle className="w-3 h-3" />
            <span className="text-[9px] font-mono font-semibold">3 WARN</span>
          </div>
        </div>
