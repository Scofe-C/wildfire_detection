...
def fixture_a_quiet() -> dict:
    ...
    return {
        ...
        "xgboost_top_cells": [{"h3_index": "8928308280fffff", "probability": 0.23, "lat": 37.4, "lon": -119.5},
                              {"h3_index": "8928308281fffff", "probability": 0.18, "lat": 37.5, "lon": -119.6}],
...
def valid_incident_json() -> dict:
    ...
    return {
        ...
        "disclaimer": "AI-generated. Not for operational use without human review.",
        "data_sources_used": ["xgboost_scores", "propagator", "firms_hotspots", "fema_nri"],
...
def valid_final_json() -> dict:
    ...
    return {
        ...
        "human_input_included": True,
        "disclaimer": "AI-generated. Not for operational use without human review.",
        "data_sources_used": ["xgboost_scores", "propagator", "firms_hotspots"],
        "incident_name": "Oak Ridge Fire",
